...
const components = {};
function components_1b859b2c(nuxtApp) {
...
const vueuseHead_b2efc466 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_69c50fc1 = defineNuxtPlugin((nuxtApp) => {
...
const router_6302a379 = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
